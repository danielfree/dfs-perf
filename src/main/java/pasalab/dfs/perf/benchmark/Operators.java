...
public class Operators {
  ...
  private static final String file = "/home/ubuntu/dfs-perf/train_v4.txt";
  ...
  private static void writeContentToFile(OutputStream os, long fileSize, int bufferSize)
      throws IOException {
    int type = PerfConf.get().DFS_PERF_WRITE_TYPE;
    byte[] content = new byte[bufferSize];
    switch (type) {
      //repeated integer
      case 1:
      default:
        ...
        int random = RAND.nextInt(bufferSize);
      ...
      case 2:
        ...
        break;
      //sample texts, limits to disk I/O
      case 3:
        FileChannel fileChannel = new RandomAccessFile(file,"r").getChannel();
        MappedByteBuffer mappedByteBuffer = fileChannel.map(MapMode.READ_ONLY,RAND.nextInt(bufferSize),bufferSize);
